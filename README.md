...
- **Methodology:** Structural Equation Modeling (SEM) and Confirmatory Factor Analysis (CFA). Additional Analyses with Welch and pared-sample t-tests.
- **Planned Sample:** N=588 German-speaking participants (recruited via Prolific). Final sample of this study included 318 participants.
...
4. Depending on the data you have, you probably can skip the preprocessing steps.
